    ...
    <div className="bg-green pt-[46px] lg:pt-[140px] pb-40 lg:pb-[228px] -translate-y-[90px] md:-translate-y-[140px] px-4 overflow-hidden">
      <div className=" max-w-[1220px] mx-auto px-4 lg:px-4" data-aos="fade-up">
        ...
        <div className="lg:flex gap-8 mt-[60px] lg:mt-[112px]">
          <div
            className="rounded-lg bg-white shadow-sm mb-16 lg:mb-0 pl-3 pt-3 sm:w-[383px] mx-auto lg:w-[unset] min-h-[386px] relative"
            data-aos="fade-right"
          >
            ...
            <img
              src="/images/opd-1.png"
              alt=""
              className="absolute right-0 bottom-0"
            />
          </div>
          <div
            className="rounded-lg shadow-sm bg-white mb-16 lg:mb-0 pl-3 pt-3 sm:w-[383px] mx-auto lg:w-[unset] min-h-[386px]"
            data-aos="fade-down"
          >
          ...
          <div
            className="rounded-lg shadow-sm pl-3 pt-3 bg-white sm:w-[383px] mx-auto lg:w-[unset] min-h-[386px]"
            data-aos="fade-left"
          >
